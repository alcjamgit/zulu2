...
namespace ShareWealth.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/App/cssbundle").Include(
                    "~/app/vendors/socicon/socicon.min.css",
                    "~/app/vendors/bower_components/animate.css/animate.min.css",
                    "~/app/vendors/bower_components/material-design-iconic-font/css/material-design-iconic-font.css",
