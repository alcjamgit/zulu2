    ...
    .directive('sparklineBar', function(){
        ...
        return {
            ...
            link: function(scope, element) {
                ...
                //
                sparkLineBar('.stats-bar', [1700,1220,1260,1303,1303,1432,1586,2174,2650,2600,2534,3410,3400,3425,3902,4115,3567], '45px', 3, '#fff', 2);
                //Open Trades
    ...
    .directive('sparklineLine', function(){
        ...
        return {
            ...
            link: function(scope, element) {
                ...
                sparkLineLine('.stats-line', [80000,76000,73000,61100,50000,71000,45000,50500,45000,75100,60000,51887], 85, 45, '#fff', 'rgba(0,0,0,0)', 1.25, 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 3, '#fff', 'rgba(255,255,255,0.4)');
                sparkLineLine('.stats-line-2', [73000,61100,50000,61100,50000,71000,45000,50500,75100,60000,60500,80600], 85, 45, '#fff', 'rgba(0,0,0,0)', 1.25, 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 3, '#fff', 'rgba(255,255,255,0.4)');
