    ...
    .directive('sparklineBar', function(){
        ...
        return {
            ...
            link: function(scope, element) {
                ...
                //
                sparkLineBar('.stats-bar', [12000,12000,9500,13000,13000,14300,15000,16000,25000,15000,15000,15000,19000,11000,12000,14600,15000], '45px', 3, '#fff', 2);
                //Open Trades
                sparkLineBar('.stats-bar-2', [16,9,11,15,17,13,18,17,19,21,16,23,23,25,25,19,21], '45px', 3, '#fff', 2);
            }
        }
    })
    ...
    .directive('sparklineLine', function(){
        ...
        return {
            ...
            link: function(scope, element) {
                ...
                sparkLineLine('.stats-line', [80000,76000,73000,61100,50000,71000,45000,50500,45000,75100,60000,60500], 85, 45, '#fff', 'rgba(0,0,0,0)', 1.25, 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 3, '#fff', 'rgba(255,255,255,0.4)');
                sparkLineLine('.stats-line-2', [73000,61100,50000,61100,50000,71000,45000,50500,75100,60000,60500,75000], 85, 45, '#fff', 'rgba(0,0,0,0)', 1.25, 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 'rgba(255,255,255,0.4)', 3, '#fff', 'rgba(255,255,255,0.4)');
