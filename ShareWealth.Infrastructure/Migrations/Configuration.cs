    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        private void SeedWatchlistSecurities(ApplicationDbContext context)
        {
            ...
            for (int i = 1; i < 63; i++)
            {
                for (int m = 1; m < 10; m++)
                {
                    var w = new WatchlistSecurity { Id = j, WatchlistId = i, SecurityId = m + n  };
                    j++; m++;
                    watchlistSec.Add(w);
                }
                n = (n==90) ? 0: n+10;
        ...
        //                continue;
        //            }
        //            var randomPrice = new Random().Next(0, 100);
        //            var stockPrice = new StockPrice { Id = 2 , Open = randomPrice};
        //        }
        ...
        //    {
        //        if (!context.StockPrices.Any(w => w.Id == sp.Id))
        //        {
